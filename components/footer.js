  ...
  <div class="footer-grid">
    <div class="footer-brand">
      <a href="${base}index.html" class="footer-logo">
        <img class="logo" src="${base}images/DigitalEase logo.png">
      </a>
    ...
    <div>
      ...
      <ul class="footer-links">
        <li><a href="${base}components/files/privacy-policy.html">Privacy Policy</a></li>
        <li><a href="${base}components/files/terms-of-service.html">Terms of Service</a></li>
      </ul>
    </div>
